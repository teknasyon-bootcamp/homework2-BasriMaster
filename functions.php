<?php
    ...
    if ($_SERVER['SERVER_NAME'].$_SERVER['REQUEST_URI'] == 'localhost/odev2/functions.php') {

        /* 

            derste görmedik ama ben kendi araştırmamla buldum server globeli ile url i bu şekilde alabiliyoruz
        */

        echo '<img src="kimsinsen.png" width="500" height="700" />';
        header("Refresh:7; url=./post.php");
        exit();
